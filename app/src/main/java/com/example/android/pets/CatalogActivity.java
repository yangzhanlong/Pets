...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        String[] projection = {PetContract.PetEntry._ID,
                               ...
                               PetContract.PetEntry.COLUMN_WEIGTH,
        ...
        try {
            ...
            int weightColumnIndex = cursor.getColumnIndex(PetContract.PetEntry.COLUMN_WEIGTH);
    ...
    private void inserPets() {
        ...
        values.put(PetContract.PetEntry.COLUMN_WEIGTH, 7);
